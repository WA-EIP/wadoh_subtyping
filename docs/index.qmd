...
:::{.title-header}
[wadoh_subtyping]{style="font-family: 'JetBrains Mono'; border-style: solid; border-width: 3px; border-radius: 5px; border-color: black; margin: 20px; padding:12px;"} python package
:::
